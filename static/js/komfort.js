...
function init() {
	...
	const axesHelper = new THREE.AxesHelper(1000); // 1000 мм длина каждой оси
	scene.add(axesHelper);
	...
	function createAxisLabel(text, color, position) {
		...
		sprite.scale.set(550, 550, 550); // Размер подписи
		return sprite;
	}
...
if(widthProscet > 1200){
	var peremI = Math.ceil((widthProscet - 80) / 500) - 1; 
} 
